...
const Education = () => {
  ...
  const activities = [
    ...
    {
      role: 'Participant',
      event: 'StartUp Spark, ACMX, FOSS4ML, Design Thinking Summit, Agile Seminar',
      date: ''
    }
  ];
    ...
    >
      ...
      <div className="education-content">
        ...
        <motion.div className="certifications" variants={itemVariants}>
          <h3>
            <FaTrophy className="section-icon" /> {t('education.certifications')}
          </h3>
          <motion.div className="cert-list" variants={containerVariants}>
        ...
        <motion.div className="activities" variants={itemVariants}>
          <h3>
            <FaUsers className="section-icon" /> {t('education.activities')}
          </h3>
          <motion.div className="activities-list" variants={containerVariants}>
